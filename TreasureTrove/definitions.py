...
from TreasureTrove.io_managers.pandas_io_manager import CsvIngestionIOManager, CsvIOManager
...
defs = Definitions(
    ...
    resources={
        "pandas_csv_full_update": CsvIOManager(),
        "pandas_csv_ingestion": CsvIngestionIOManager(),
        "env": EnvResource(
